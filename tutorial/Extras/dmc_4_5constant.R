...
### Lesson 4.5fixed: Hierarchial model where some hyper-parameters 
...
# NA). We use exponential priors for remaning parameters.
...
### Can also make a location parameter a consant, here we do it with t0, setting
...
### Can even have both a scale and location parameter a consant, here t0, again

...
### Lesson 4.7: Hierarchical DDM Model with sampling failure and group parameters
...
# similar problems dont occur with larger sv. Chain update mixing in DMC 
# (defualt random.phi=TRUE and random.theta=TRUE) sovles the convergence 
...
# As in the LBA example suppose we have little idea about indivdiual variation 
...
# Set sv and sz to a constant in model (value doenst matter)
...
# Mean recovery not to bad except for sv (a bit worse than indidiual) and sz

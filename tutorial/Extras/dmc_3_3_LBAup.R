...
### Lesson 3.3 Extra:  Sampling and assessing a single LBA subject, using an  
###   unbounded parameterization (except st0), all parametrs sampled on log scale
###   Model like 3.3 but estiamtes sd_v.true (fix sd_v.false=1). Shows that 
###   even though this model shoudl be indentified it fails in both the unbounded
###   and orignal parameterization (see end of file).

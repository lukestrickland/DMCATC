...
unlist(p.prior$sdlog.true)    # Default lower is added; no upper bound for lnrom
unlist(p.prior$t0)            # Default upper is added; no upper bound for lnrom
...
p.prior2$t0           # lower is set to .1; no upper bound for lnrom
...
#  -43128.77  (this chages for each new data set)

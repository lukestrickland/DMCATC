...
#    effects, just as you would run experiments and analyze data to understand
#    the effects of experimental manipulations.
# 2) So you can check your estimation procedure is working. If you cant recover
...
# model fitting. As you will see in later lessons haveing a likelihood is the

...
# "go failure" means that on some proprotion of trials participants fail to 
# respond: we estiamte a parameter "gf" to account for this.
...
# Model where B depends on S as s1 and s2 in differnet blocks
modelS <- model.dmc(

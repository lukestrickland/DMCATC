...
# check this.
#
# Note that model.dmc is very picky about overlap in factor levels, particulary
...
#
# Avoid superfulous columns, they are usually ignored but can sometimes cause
# problems.
#

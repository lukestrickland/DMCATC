...
# IN a hierarchcial model we assume that each subject's parameters are sampled 
# from population distributions. For an introduction to the benifits of 
...
# Now make a prior for the population parameters. We wont make use of it at
...
#
# The p.mu prior standard deviations should be fairly large if we dont
...
# gamma, are postively skewed distributions. You can play with the setting of

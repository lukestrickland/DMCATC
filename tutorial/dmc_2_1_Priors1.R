...
### Example 2: Combination of differnt priors for different parameters
...
# later lesson. For no you will use dmc_2.1.RData contains the results of 
# fitting the LNR model to two data sets, data.big features 2x1000 RTs and 
# data.small contains 2x15 RTs. Both data sets were fit using a weakly 
...
# We're now going to look at the credibile intervals for our estimates to 
...
# having set meanlog.true to equal -1, and taking the 95% credibile interval 

...
```{r compute nonresponse predictions, echo=FALSE, include=FALSE, eval=FALSE}
...
```{r plot RT fits PM, echo=FALSE, fig.height=3, fig.width=7}
...
```{r plot nonresponse proportions, echo=FALSE, eval=FALSE, fig.height=3, fig.width=7}
...
```{r plot thresholds, echo=FALSE, fig.height=4.5, fig.width=7}
...
```{r plot rates, echo=FALSE, fig.height=12, fig.width=7}

...
pairs(tlx[ tlx$block=="PM",-c(1,2,3,4,6,8,10)])
...
ggplot(tlx, aes(x=mental, y=mean_v.C, color=block)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm)   # Add linear regression line

ggplot(tlx, aes(x=physical, y=mean_v.C, color=block)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm)   # Add linear regression line

ggplot(tlx, aes(x=temporal, y=mean_v.C, color=block)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm)   # Add linear regression line

ggplot(tlx, aes(x=performance, y=mean_v.C, color=block)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm)   # Add linear regression line

ggplot(tlx, aes(x=effort, y=mean_v.C, color=block)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm)   # Add linear regression line

ggplot(tlx, aes(x=frustration, y=mean_v.C, color=block)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm)   # Add linear regression line

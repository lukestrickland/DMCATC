...
```{r fits accuracy, echo=FALSE, out.width='80%'}

knitr::include_graphics("figures/E1/E1.Fits.Accuracy.png")

```

- Figure below shows model fits to ongoing task correct and error RT by time pressure and PM block

```{r fits RT ongoing, echo=FALSE, out.width='80%'}

knitr::include_graphics("figures/E1/E1.Fits.RT.Ongoing.png")
